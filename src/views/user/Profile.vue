<template>
    <div class="md:ml-[250px] ml-0 bg-sky-950 font-Times New Roman px-0 w-full">
        ...
        <div class="bg-stone-200 min-h-[44rem] card overflow-x-auto">
            <div class="px-2 py-4 flex flex-col justify-center items-center text-center pt-16" id="container">
                <div v-if="showProfile">
                    <div class="profile-card border-2 rounded-2xl mb-2">
                      <div class="card-container mt-8 grid gap-4 lg:grid-cols-2 sm-grid-cols-1 p-5 m-10">
                        <div class="profile-pic border-2 border-sky-950 w-[300px] rounded-2xl shadow-inner shadow-sky-950">
                          <img class="object-cover cursor-pointer ml-[50px] mt-4 flex flex-col border-4 mb-2 border-sky-900 dark:border-sky-700 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-sky-800/100 dark:shadow-sky-900/100
                           bg-sky-50 dark:bg-sky-900 text-sky-800 dark:text-sky-800 h-[200px] w-[200px]" src="../../assets/pic2.jpg" alt="Student Profile">                   
                        </div>                  
                        <div class="second-col">
                          <h1 class="text-2xl text-sky-950 font-bold mt-2 border-2 border-sky-950 rounded-lg bg-white shadow-inner shadow-sky-950">Cordova Public College</h1>
                          <h2 class="text-2xl text-white font-bold mt-2">{{user.infos.fullname}}</h2>
                          <p class="text-md text-white mt-2">Student ID: {{ user.id_number }}</p>
                          <h2 class="text-base md:text-xl text-white font-bold">Course: {{user.infos.course}}</h2>
                    ...
                    <div class="max-w-full items-center flex overflow-x-auto border-2 shadow-md rounded-2xl">
                    <table class="w-full text-sm text-left rtl:text-right text-black dark:text-gray-400 border bg-white">
                      <thead class="text-xs text-gray-700 uppercase bg-sky-950 shadow-inner shadow-sky-950 text-center">
                        <tr class="text-white">
