 <template>
        ...
        <button @click="handleBackButton" type="button" id="back" value="back" class="border border-red-100">Back</button>
            <div>
                ...
                <QuestionForm class="text-black question-card pb-4 rounded-2xl mt-4 mx-4 bg-gray-50 dark:bg-gray-700 dark:text-gray-400 question-card"
                ...
                <div class="flex justify-between mb-2 mx-4">
                    ...
                    <button type="button" id="submit-btn" value="submit" @click="handleSubmit">Submit</button>
                </div>
            </div>
        </div>
        <FooterCard/>  
