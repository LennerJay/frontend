<template>
    <div class="md:ml-[250px] ml-0 font-poppins px-0 w-full dashboard-main-header">
        <div class="header pl-2 md:py-6 text-white bg-sky-900 text-center">
       ...
       <div class="card">
            <div class="flex flex-col min-h-[43.2rem]">
                ...
                text-center bg-gradient-to-r from-sky-50 via-indigo-300 to-sky-50 rounded-2xl" id="cards">Overview Section</h1>
                <!-- CARD SECTION -->
                <div class="card-container mt-8 grid gap-10 lg:grid-cols-3 sm-grid-cols-1 p-5 m-10 rounded-md">
                    <div class="first-card first-letter:bg-sky-900 flex flex-col justify-center items-center text-center h-32
                    cursor-pointer bg-gradient-to-r from-indigo-200 
                    hover:-translate-y-1 hover:scale-90 rounded-2xl" id="cards">
                    ...
                    <div class="first-card first-letter:bg-sky-900 flex flex-col justify-center items-center text-center h-32
                    cursor-pointer bg-gradient-to-r from-indigo-200  via-white to-indigo-200 
                    hover:-translate-y-1 hover:scale-90 rounded-2xl" id="cards">
                        <h1 class="hover:text-indigo-500">
                    ...
                    <div class="first-card first-letter:bg-sky-900 flex flex-col justify-center items-center text-center h-32
                    cursor-pointer bg-gradient-to-l from-indigo-200 
                    hover:-translate-y-1 hover:scale-90 rounded-2xl" id="cards">
                        <h1 class="hover:text-indigo-500">
                ...
                <!-- GRAPH SECTION -->
                <div class="card-container mt-8 grid gap-10 lg:grid-cols-2 sm-grid-cols-1 p-5 m-10 rounded-md">
                ...
                <div class="table-container card mt-8 p-5 m-8 rounded-md bg-white max-w-full items-center max-h-[500px] md:max-h-[300px]" id="cards">
                    <h1 class="block text-black font-bold font-poppins">CHAIRPERSON</h1>
                    <div class="shadow-md sm:rounded-lg mt-4 overflow-auto md:max-h-[200px] max-h-[200px]">
                        <table class="w-full text-sm text-left rtl:text-right text-black">
                            ...
                            <tbody class="text-black">
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 text-left cursor-pointer">
