<template>
  <div class="content">
    ...
    <div v-if="showTable">
      ...
      <h1>Title: {{ selectedQuestionaire.title }}</h1>
      <p>Description: {{ selectedQuestionaire.description }}</p>
      ...
      <table
        v-for="(criteria, key) in selectedQuestionaire.criterias"
        :key="key"
        class="border border-black p-1 m-3"
      >
        <thead>
          <tr>
    ...
    <div v-else class="flex gap-2">
      <div
        ...
        @click="selectQuestionaire(questionaire.id)"
      >
