<template>
    <div>
        <div class="container max-w-7xl mx-auto mt-8">
            <div class="mb-4">
                <h1 class="font-serif text-3xl font-bold underline decoration-gray-400 mb-4">{{ title }}</h1>
                <div class="flex justify-between">
                    <div ref="selectRef" class="flex">
                       <span>Filter Department : </span> <SelectTag  @selectValue="selectedValue"  :course="list" @show="show" :open="open" @closeTag="closeTag" :option="'departments'"></SelectTag>
                    </div>
