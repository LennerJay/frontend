<template>
  <aside class="w-0 font-Times New Roman">
    <div class="sidebar min-h-screen fixed top-0 lg:left-0 p-2 w-[250px] overflow-y-auto text-center z-50" :class="{ 'left-0': !drawer.drawerState, 'left-[-250px]': drawer.drawerState }">
