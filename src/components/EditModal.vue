<template>
    <!-- Modal container -->
  <div v-if="editOpen" class="fixed inset-0 bg-sky-950 bg-opacity-5 items-center justify-center font-Times New Roman">
      <div class="bg-white p-8 max-w-md mx-auto mt-48 border-4 border-sky-950 rounded-xl max-h-[26rem] overflow-y-auto">
          ...
          <div class="mb-4 flex flex-col">
              <h2 class="text-2xl font-semibold text-center bg-sky-950 text-white mb-2">Edit Teacher</h2>
          </div>
          <!-- Modal body -->
          <div class="mb-4">
              <div>
...
const editModal = userModalStore();
const { emit } = editModal;
const props = defineProps([
  'editOpen'
]);
const emits = defineEmits(['editNotOpen']);
