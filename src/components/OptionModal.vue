  ...
  <div class="fixed inset-0 bg-sky-950 bg-opacity-5 items-center justify-center font-Times New Roman z-20">
      <div class="bg-white p-8 max-w-md mx-auto mt-48 border-4 border-sky-950 rounded-xl max-h-[26rem] overflow-y-auto">
          ...
          <div class="flex justify-end space-x-4">
              ...
              <button @click="addOption" class="bg-sky-950 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                  Delete
              </button>
          </div>
      </div>
...
const emits = defineEmits(['closeButton','addOption']);
...
const addOption = ()=>{
    emits('addOption',props.evaluateeDetails.id)
}
